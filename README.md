...
[![CI](https://github.com/YawLabs/electron-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/YawLabs/electron-mcp/actions/workflows/ci.yml) [![Release](https://github.com/YawLabs/electron-mcp/actions/workflows/release.yml/badge.svg)](https://github.com/YawLabs/electron-mcp/actions/workflows/release.yml)
...
- **Version-aware migration** — `electron_migrate_version` knows the breaking changes from v20 through v41 and tells you exactly what will break when you bump. `electron_check_deprecated_apis` scans your code for APIs that were removed.
