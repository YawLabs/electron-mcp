...
if [ "$PUBLISHED_VERSION" = "$VERSION" ]; then
  ...
  [ "$NPM_NOW" = "$VERSION" ] || fail "CI workflow succeeded but npm registry still shows '$NPM_NOW' for @yawlabs/electron-mcp@${VERSION}. Likely propagation lag -- retry verification in a minute."
